...
Automation IDs are assigned to primary controls, including `CameraSelector`, `FormatSelector`, `LivePreviewImage`, `InspectionOverlayCanvas`, `SnapshotButton`, `ChooseSnapshotFolderButton`, `SnapshotFolderPathText`, `FreezeInspectToggle`, `CrosshairToggle`, `GridToggle`, `RulersToggle`, `AnnotationToolSelector`, `StrokeColorSelector`, `StrokeThicknessSlider`, `CalibrationProfileSelector`, `CalibrationStatusText`, `MeasurementStatusText`, `OpenInspectionButton`, `MirrorToggle`, `FullscreenButton`, and `StatusText`.
